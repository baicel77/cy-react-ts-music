...
export const artistCategories = [
    ...
    artists: [
      {
        name: '推荐歌手',
        type: 1,
        url: '/discovery/artist',
        id: 0
      },
      {
        name: '入驻歌手',
        type: 2,
        url: '/discovery/artist?cat=5001',
  ...
  },
  {
    ...
    artists: [
      {
        name: '华语男歌手',
        url: '/discovery/artist?id=1001',
        type: 1
      },
      {
        name: '华语女歌手',
        url: '/discovery/artist?id=1002',
        type: 2
      },
      {
        name: '华语组合/乐队',
        url: '/discovery/artist?id=1003',
        type: 3
      }
    ]
  },
  {
    ...
    artists: [
      {
        name: '欧美男歌手',
        url: '/discovery/artist?id=2001',
        type: 1
      },
      {
        name: '欧美女歌手',
        url: '/discovery/artist?id=2002',
        type: 2
      },
      {
        name: '欧美组合乐队',
        url: '/discovery/artist?id=2003',
        type: 3
      }
    ]
  },
  {
    ...
    artists: [
      {
        name: '日本男歌手',
        url: '/discovery/artist?id=6001',
        type: 1
      },
      {
        name: '日本女歌手',
        url: '/discovery/artist?id=6002',
        type: 2
      },
      {
        name: '日本组合/乐队',
        url: '/discovery/artist?id=6003',
        type: 3
      }
    ]
  },
  {
    ...
    artists: [
      {
        name: '韩国男歌手',
        url: '/discovery/artist?id=7001',
        type: 1
      },
      {
        name: '韩国女歌手',
        url: '/discovery/artist?id=7002',
        type: 2
      },
      {
        name: '韩国组合/乐队',
        url: '/discovery/artist?id=7003',
        type: 3
      }
    ]
  },
  {
    ...
    artists: [
      {
        name: '其他男歌手',
        url: '/discovery/artist?id=4001',
        type: 1
      },
      {
        name: '其他女歌手',
        url: '/discovery/artist?id=4002',
        type: 2
      },
      {
        name: '其他组合乐队',
        url: '/discovery/artist?id=4003',
        type: 3
      }
    ]
  }
